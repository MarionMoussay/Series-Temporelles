...
```
La p-valeur est supérieure au seuil de signification, on peut alors conclure que les valeurs résiduelles sont indépendantes et donc décorrélées.
...
p2 <- ggAcf(budapest_dec$random, lag.max = 20) + ggtitle(" ")
p3 <- ggPacf(budapest_dec$random, lag.max = 20) +  ggtitle(" ")
