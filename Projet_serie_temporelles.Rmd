...
De cette première représentation, nous remarquons directement une forte saisonnalité d'un an, soit 52 semaines dans notres cas. Nous n'observons pas vraiment de tendance ou alors une légère décroissance mais cela reste difficile à dire avec ce graphique. De plus, on imagine un modèle additif puisque l'on voit une amplitude plutot constante.
